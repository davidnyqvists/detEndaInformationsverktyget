...
public class AccountManagement extends javax.swing.JFrame {
    ...
    public void getInfo() {
        ...
        if (test != null) {
            ...
            chk_AccountManagement_AndraKonto_Research.setSelected(false);
        }
        ...
        if (test2 != null) {
            ...
            chk_AccountManagement_AndraKonto_Education.setSelected(false);
        }
        //Kollar FadminStatus
        ...
        if (test3 != null) {
            ...
            chk_AccountManagement_AndraKonto_ResearchAdmin.setSelected(false);
        }
        //Kollar uAdminStatus
        ...
        if (test4 != null) {
            ...
            chk_AccountManagement_AndraKonto_EducationAdmin.setSelected(false);
        }
        //Kollar utbildningstatus
        ...
        if (test5 != null) {
            ...
            chk_AccountManagement_AndraKonto_SystemAdmin.setSelected(false);
        }
...
System.out.println("SQL GET " + sqlGuiUserName + sqlGuiUserPassword + sqlGuiName);
        ...
        { 
            dataBase.getId("DELETE FROM PERSON_FORSKNING WHERE PERSON_FORSKNING.PERSONID = '" + newPid + "'");
        }
        

        if (chk_AccountManagement_AndraKonto_Education.isSelected() == true) {
            dataBase.insertIntoTable("PERSON_UTBILDNING", newPid);
            
        }
         else
        { 
            dataBase.getId("DELETE FROM PERSON_UTBILDNING WHERE PERSON_UTBILDNING.PERSONID = '" + newPid + "'");
        }

        if (chk_AccountManagement_AndraKonto_ResearchAdmin.isSelected() == true) {
            dataBase.insertIntoTable("PERSON_FORSKNING_ADMIN", newPid);
        }
        else
        { 
            dataBase.getId("DELETE FROM PERSON_FORSKNING_ADMIN WHERE PERSON_FORSKNING_ADMIN.PERSONID = '" + newPid + "'");
        }
        

        if (chk_AccountManagement_AndraKonto_EducationAdmin.isSelected() == true) {
            dataBase.insertIntoTable("PERSON_UTBILDNING_ADMIN", newPid);
        }
        else
        { 
            dataBase.getId("DELETE FROM PERSON_UTBILDNING_ADMIN WHERE PERSON_UTBILDNING_ADMIN.PERSONID = '" + newPid + "'");
        }

        if (chk_AccountManagement_AndraKonto_SystemAdmin.isSelected() == true) {
